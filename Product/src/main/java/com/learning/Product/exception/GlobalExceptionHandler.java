...
import com.learning.Product.dto.ExceptionResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponseDTO> handleCategoryAreadyExistsException(CategoryAlreadyExistsException ex, WebRequest webRequest){
